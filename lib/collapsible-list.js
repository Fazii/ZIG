        ...
        return this.each(function () {
            ...
            function setHeadersClickHandler() {
                headers.on('click', function() {
                    if(isHeaderCollapsed($(this)) || event.target.className.indexOf('header') > -1)
                        toggleCollapse($(this));
                });
            }
            ...
            init();
            var animateParam = options.animate;
            options.animate = false;
            headers.each(function(){collapseHeader(headers);});
            options.animate = animateParam;
        });
    };
})(jQuery);